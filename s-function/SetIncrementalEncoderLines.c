/*
 * File: SetIncrementalEncoderLines.c
 *
 *
...
#define S_FUNCTION_NAME SetIncrementalEncoderLines
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void SetIncrementalEncoderLines_Outputs_wrapper(const uint8_T *Address,
			...
			int32_T *Error,
			void **pW);
extern void SetIncrementalEncoderLines_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    SetIncrementalEncoderLines_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    SetIncrementalEncoderLines_Outputs_wrapper(Address, Value, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    SetIncrementalEncoderLines_Terminate_wrapper(pW);
