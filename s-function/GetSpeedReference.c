 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Jul 08 17:16:48 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME GetSpeedReference
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void GetSpeedReference_Start_wrapper(void **pW);
extern void GetSpeedReference_Outputs_wrapper(const uint8_T *Address,
			int32_T *Result,
			int32_T *Error,
			void **pW);
extern void GetSpeedReference_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    GetSpeedReference_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    GetSpeedReference_Outputs_wrapper(Address, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    GetSpeedReference_Terminate_wrapper(pW);
