 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Jul 08 16:33:51 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME GetSpeedFeedback
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void GetSpeedFeedback_Start_wrapper(void **pW);
extern void GetSpeedFeedback_Outputs_wrapper(const uint8_T *Address,
			int32_T *Result,
			int32_T *Error,
			void **pW);
extern void GetSpeedFeedback_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    GetSpeedFeedback_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    GetSpeedFeedback_Outputs_wrapper(Address, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    GetSpeedFeedback_Terminate_wrapper(pW);
