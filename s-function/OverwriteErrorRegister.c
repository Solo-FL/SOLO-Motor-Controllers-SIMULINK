 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed May 04 11:55:58 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME OverwriteErrorRegister
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void OverwriteErrorRegister_Start_wrapper(void **pW);
extern void OverwriteErrorRegister_Outputs_wrapper(const uint8_T *Address,
			boolean_T *Result,
			int32_T *Error,
			void **pW);
extern void OverwriteErrorRegister_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    OverwriteErrorRegister_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    OverwriteErrorRegister_Outputs_wrapper(Address, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    OverwriteErrorRegister_Terminate_wrapper(pW);
