 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed May 04 11:35:22 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME SetMotorDirection
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void SetMotorDirection_Start_wrapper(void **pW);
extern void SetMotorDirection_Outputs_wrapper(const uint8_T *Address,
			const boolean_T *Value,
			boolean_T *Result,
			int32_T *Error,
			void **pW);
extern void SetMotorDirection_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    SetMotorDirection_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    SetMotorDirection_Outputs_wrapper(Address, Value, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    SetMotorDirection_Terminate_wrapper(pW);
