 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu May 05 21:09:34 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME serialIsWorking
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void serialIsWorking_Start_wrapper(void **pW);
extern void serialIsWorking_Outputs_wrapper(const uint8_T *Address,
			boolean_T *Result,
			int32_T *Error,
			void **pW);
extern void serialIsWorking_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    serialIsWorking_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    serialIsWorking_Outputs_wrapper(Address, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    serialIsWorking_Terminate_wrapper(pW);
