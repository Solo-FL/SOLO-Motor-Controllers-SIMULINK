 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed May 04 11:47:26 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME SetControlMode
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void SetControlMode_Start_wrapper(void **pW);
extern void SetControlMode_Outputs_wrapper(const uint8_T *Address,
			const uint8_T *Value,
			boolean_T *Result,
			int32_T *Error,
			void **pW);
extern void SetControlMode_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    SetControlMode_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    SetControlMode_Outputs_wrapper(Address, Value, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    SetControlMode_Terminate_wrapper(pW);
