 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed May 04 11:50:16 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME SetMonitoringMode
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void SetMonitoringMode_Start_wrapper(void **pW);
extern void SetMonitoringMode_Outputs_wrapper(const uint8_T *Address,
			const boolean_T *Value,
			boolean_T *Result,
			int32_T *Error,
			void **pW);
extern void SetMonitoringMode_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    SetMonitoringMode_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    SetMonitoringMode_Outputs_wrapper(Address, Value, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    SetMonitoringMode_Terminate_wrapper(pW);
