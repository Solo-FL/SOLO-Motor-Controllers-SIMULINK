/*
 * File: MotorParametersIdentification.c
 *
 *
 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed May 04 11:27:52 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME MotorParametersIdentification
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void MotorParametersIdentification_Start_wrapper(void **pW);
extern void MotorParametersIdentification_Outputs_wrapper(const uint8_T *Address,
			const boolean_T *Value,
			boolean_T *Result,
			int32_T *Error,
			void **pW);
extern void MotorParametersIdentification_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    MotorParametersIdentification_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const boolean_T *Value = (boolean_T *) ssGetInputPortRealSignal(S, 1);
    boolean_T *Result = (boolean_T *) ssGetOutputPortRealSignal(S, 0);
    int32_T *Error = (int32_T *) ssGetOutputPortRealSignal(S, 1);

    MotorParametersIdentification_Outputs_wrapper(Address, Value, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    MotorParametersIdentification_Terminate_wrapper(pW);
