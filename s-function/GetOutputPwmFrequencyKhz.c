/*
 * File: GetOutputPwmFrequencyKhz.c
 *
 *
 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Jul 08 17:09:10 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME GetOutputPwmFrequencyKhz
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void GetOutputPwmFrequencyKhz_Start_wrapper(void **pW);
extern void GetOutputPwmFrequencyKhz_Outputs_wrapper(const uint8_T *Address,
			int32_T *Result,
			int32_T *Error,
			void **pW);
extern void GetOutputPwmFrequencyKhz_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    GetOutputPwmFrequencyKhz_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    GetOutputPwmFrequencyKhz_Outputs_wrapper(Address, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    GetOutputPwmFrequencyKhz_Terminate_wrapper(pW);
