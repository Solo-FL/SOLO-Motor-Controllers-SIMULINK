/*
 * File: SetMagnetizingCurrentIdReference.c
 *
 *
 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed May 04 11:51:20 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME SetMagnetizingCurrentIdReference
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void SetMagnetizingCurrentIdReference_Start_wrapper(void **pW);
extern void SetMagnetizingCurrentIdReference_Outputs_wrapper(const uint8_T *Address,
			const real32_T *Value,
			boolean_T *Result,
			int32_T *Error,
			void **pW);
extern void SetMagnetizingCurrentIdReference_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    SetMagnetizingCurrentIdReference_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    SetMagnetizingCurrentIdReference_Outputs_wrapper(Address, Value, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    SetMagnetizingCurrentIdReference_Terminate_wrapper(pW);
