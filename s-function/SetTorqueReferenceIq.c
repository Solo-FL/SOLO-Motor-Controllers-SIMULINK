 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Fri Jul 22 09:56:32 2022
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                SetTorqueReferenceIq
...
extern void SetTorqueReferenceIq_Start_wrapper(void **pW);
extern void SetTorqueReferenceIq_Outputs_wrapper(const uint8_T *Address,
  const real32_T *Value,
  boolean_T *Result,
  int32_T *Error,
  void **pW);
extern void SetTorqueReferenceIq_Terminate_wrapper(void **pW);
...
static void mdlStart(SimStruct *S)
{
  ...
  SetTorqueReferenceIq_Start_wrapper(pW);
}
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  SetTorqueReferenceIq_Outputs_wrapper(Address, Value, Result, Error, pW);
}
...
{
  void **pW = ssGetPWork(S);
  SetTorqueReferenceIq_Terminate_wrapper(pW);
}
