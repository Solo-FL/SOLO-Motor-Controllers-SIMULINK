 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu May 05 20:16:22 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME GetUartBaudrate
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void GetUartBaudrate_Start_wrapper(void **pW);
extern void GetUartBaudrate_Outputs_wrapper(const uint8_T *Address,
			uint32_T *Result,
			int32_T *Error,
			void **pW);
extern void GetUartBaudrate_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    GetUartBaudrate_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    GetUartBaudrate_Outputs_wrapper(Address, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    GetUartBaudrate_Terminate_wrapper(pW);
