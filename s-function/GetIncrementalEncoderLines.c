/*
 * File: GetIncrementalEncoderLines.c
 *
 *
 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu May 05 19:22:41 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME GetIncrementalEncoderLines
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void GetIncrementalEncoderLines_Start_wrapper(void **pW);
extern void GetIncrementalEncoderLines_Outputs_wrapper(const uint8_T *Address,
			uint32_T *Result,
			int32_T *Error,
			void **pW);
extern void GetIncrementalEncoderLines_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    GetIncrementalEncoderLines_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    GetIncrementalEncoderLines_Outputs_wrapper(Address, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    GetIncrementalEncoderLines_Terminate_wrapper(pW);
