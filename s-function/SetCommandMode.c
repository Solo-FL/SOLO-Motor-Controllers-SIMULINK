 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sun May 01 20:17:09 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME SetCommandMode
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void SetCommandMode_Start_wrapper(void **pW);
extern void SetCommandMode_Outputs_wrapper(const uint8_T *Address,
			const boolean_T *Value,
			boolean_T *Result,
			int32_T *Error,
			void **pW);
extern void SetCommandMode_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    SetCommandMode_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    SetCommandMode_Outputs_wrapper(Address, Value, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    SetCommandMode_Terminate_wrapper(pW);
