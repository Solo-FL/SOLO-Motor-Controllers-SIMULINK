 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu May 05 19:26:55 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME GetMotorType
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void GetMotorType_Start_wrapper(void **pW);
extern void GetMotorType_Outputs_wrapper(const uint8_T *Address,
			uint32_T *Result,
			int32_T *Error,
			void **pW);
extern void GetMotorType_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    GetMotorType_Outputs_wrapper(Address, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    GetMotorType_Terminate_wrapper(pW);
