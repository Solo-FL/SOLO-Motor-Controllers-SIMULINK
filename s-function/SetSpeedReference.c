 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Jul 08 16:51:34 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME SetSpeedReference
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void SetSpeedReference_Start_wrapper(void **pW);
extern void SetSpeedReference_Outputs_wrapper(const uint8_T *Address,
			const int32_T *Value,
			boolean_T *Result,
			int32_T *Error,
			void **pW);
extern void SetSpeedReference_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    SetSpeedReference_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    SetSpeedReference_Outputs_wrapper(Address, Value, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    SetSpeedReference_Terminate_wrapper(pW);
