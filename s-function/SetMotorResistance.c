 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed May 04 11:36:33 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME SetMotorResistance
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void SetMotorResistance_Start_wrapper(void **pW);
extern void SetMotorResistance_Outputs_wrapper(const uint8_T *Address,
			const real32_T *Value,
			boolean_T *Result,
			int32_T *Error,
			void **pW);
extern void SetMotorResistance_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    SetMotorResistance_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    SetMotorResistance_Outputs_wrapper(Address, Value, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    SetMotorResistance_Terminate_wrapper(pW);
