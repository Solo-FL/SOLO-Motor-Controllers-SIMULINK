/*
 * File: SetObserverGainBldcPmsmUltrafast.c
 *
 *
 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed May 04 11:57:32 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME SetObserverGainBldcPmsmUltrafast
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void SetObserverGainBldcPmsmUltrafast_Start_wrapper(void **pW);
extern void SetObserverGainBldcPmsmUltrafast_Outputs_wrapper(const uint8_T *Address,
			const real32_T *Value,
			boolean_T *Result,
			int32_T *Error,
			void **pW);
extern void SetObserverGainBldcPmsmUltrafast_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    SetObserverGainBldcPmsmUltrafast_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real32_T *Value = (real32_T *) ssGetInputPortRealSignal(S, 1);
    boolean_T *Result = (boolean_T *) ssGetOutputPortRealSignal(S, 0);
    int32_T *Error = (int32_T *) ssGetOutputPortRealSignal(S, 1);

    SetObserverGainBldcPmsmUltrafast_Outputs_wrapper(Address, Value, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    SetObserverGainBldcPmsmUltrafast_Terminate_wrapper(pW);
