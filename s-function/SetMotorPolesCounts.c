 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Jul 08 16:56:08 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME SetMotorPolesCounts
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void SetMotorPolesCounts_Start_wrapper(void **pW);
extern void SetMotorPolesCounts_Outputs_wrapper(const uint8_T *Address,
			const int32_T *Value,
			boolean_T *Result,
			int32_T *Error,
			void **pW);
extern void SetMotorPolesCounts_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    SetMotorPolesCounts_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    SetMotorPolesCounts_Outputs_wrapper(Address, Value, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    SetMotorPolesCounts_Terminate_wrapper(pW);
