 ...
 *
 */
void SetIncrementalEncoderLines_Start_wrapper(void **pW)
{
...
pW[1] = GetProcAddress(pW[0], "_SetIncrementalEncoderLines");
 ...
 *
 */
void SetIncrementalEncoderLines_Terminate_wrapper(void **pW)
{
