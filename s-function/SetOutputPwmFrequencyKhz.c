/*
 * File: SetOutputPwmFrequencyKhz.c
 *
 *
 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Jul 08 16:54:04 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME SetOutputPwmFrequencyKhz
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void SetOutputPwmFrequencyKhz_Start_wrapper(void **pW);
extern void SetOutputPwmFrequencyKhz_Outputs_wrapper(const uint8_T *Address,
			const int32_T *Value,
			boolean_T *Result,
			int32_T *Error,
			void **pW);
extern void SetOutputPwmFrequencyKhz_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    SetOutputPwmFrequencyKhz_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    SetOutputPwmFrequencyKhz_Outputs_wrapper(Address, Value, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    SetOutputPwmFrequencyKhz_Terminate_wrapper(pW);
