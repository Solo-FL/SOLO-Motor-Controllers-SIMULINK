 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Jul 08 16:40:24 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME GetCommandMode
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void GetCommandMode_Start_wrapper(void **pW);
extern void GetCommandMode_Outputs_wrapper(const uint8_T *Address,
			int32_T *Result,
			int32_T *Error,
			void **pW);
extern void GetCommandMode_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    GetCommandMode_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    GetCommandMode_Outputs_wrapper(Address, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    GetCommandMode_Terminate_wrapper(pW);
