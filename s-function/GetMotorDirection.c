 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu May 05 18:48:58 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME GetMotorDirection
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void GetMotorDirection_Start_wrapper(void **pW);
extern void GetMotorDirection_Outputs_wrapper(const uint8_T *Address,
			uint32_T *Result,
			int32_T *Error,
			void **pW);
extern void GetMotorDirection_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    GetMotorDirection_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    GetMotorDirection_Outputs_wrapper(Address, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    GetMotorDirection_Terminate_wrapper(pW);
