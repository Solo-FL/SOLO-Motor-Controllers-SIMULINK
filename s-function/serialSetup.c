 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Apr 26 19:14:35 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME serialSetup
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Input Port  1 */
#define IN_PORT_1_NAME        COM_Port
#define INPUT_1_WIDTH         1
#define INPUT_DIMS_1_COL      5
...
/* Input Port  2 */
#define IN_PORT_2_NAME        Baud_Rate
...
/* Input Port  4 */
#define IN_PORT_4_NAME        Trials_on_Failure
...
extern void serialSetup_Start_wrapper(void **pW);
extern void serialSetup_Outputs_wrapper(const uint8_T *Address,
			...
			boolean_T *Result,
			void **pW);
extern void serialSetup_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const uint8_T *COM_Port = (uint8_T *) ssGetInputPortRealSignal(S, 1);
    const uint32_T *Baud_Rate = (uint32_T *) ssGetInputPortRealSignal(S, 2);
    const real_T *Timeout = (real_T *) ssGetInputPortRealSignal(S, 3);
    const int32_T *Trials_on_Failure = (int32_T *) ssGetInputPortRealSignal(S, 4);
    boolean_T *Result = (boolean_T *) ssGetOutputPortRealSignal(S, 0);

    serialSetup_Outputs_wrapper(Address, COM_Port, Baud_Rate, Timeout, Trials_on_Failure, Result, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    serialSetup_Terminate_wrapper(pW);
