 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed May 04 11:55:17 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME ResetPositionToZero
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void ResetPositionToZero_Start_wrapper(void **pW);
extern void ResetPositionToZero_Outputs_wrapper(const uint8_T *Address,
			boolean_T *Result,
			int32_T *Error,
			void **pW);
extern void ResetPositionToZero_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    ResetPositionToZero_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    ResetPositionToZero_Outputs_wrapper(Address, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    ResetPositionToZero_Terminate_wrapper(pW);
