 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu May 05 21:08:52 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME GetEncoderIndexCounts
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void GetEncoderIndexCounts_Start_wrapper(void **pW);
extern void GetEncoderIndexCounts_Outputs_wrapper(const uint8_T *Address,
			uint32_T *Result,
			int32_T *Error,
			void **pW);
extern void GetEncoderIndexCounts_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    GetEncoderIndexCounts_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    GetEncoderIndexCounts_Outputs_wrapper(Address, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    GetEncoderIndexCounts_Terminate_wrapper(pW);
