 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed May 04 11:45:51 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME SetMotorType
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void SetMotorType_Start_wrapper(void **pW);
extern void SetMotorType_Outputs_wrapper(const uint8_T *Address,
			const uint8_T *Value,
			boolean_T *Result,
			int32_T *Error,
			void **pW);
extern void SetMotorType_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    SetMotorType_Outputs_wrapper(Address, Value, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    SetMotorType_Terminate_wrapper(pW);
