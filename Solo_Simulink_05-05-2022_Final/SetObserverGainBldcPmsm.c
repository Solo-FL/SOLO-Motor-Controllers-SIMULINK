/*
 * File: SetObserverGainBldcPmsm.c
 *
 *
 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed May 04 11:56:44 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME SetObserverGainBldcPmsm
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void SetObserverGainBldcPmsm_Start_wrapper(void **pW);
extern void SetObserverGainBldcPmsm_Outputs_wrapper(const uint8_T *Address,
			const real32_T *Value,
			boolean_T *Result,
			int32_T *Error,
			void **pW);
extern void SetObserverGainBldcPmsm_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    SetObserverGainBldcPmsm_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    SetObserverGainBldcPmsm_Outputs_wrapper(Address, Value, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    SetObserverGainBldcPmsm_Terminate_wrapper(pW);
