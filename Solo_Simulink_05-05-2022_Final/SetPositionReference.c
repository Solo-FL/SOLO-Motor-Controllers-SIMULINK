 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed May 04 11:52:20 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME SetPositionReference
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void SetPositionReference_Start_wrapper(void **pW);
extern void SetPositionReference_Outputs_wrapper(const uint8_T *Address,
			const uint32_T *Value,
			boolean_T *Result,
			int32_T *Error,
			void **pW);
extern void SetPositionReference_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    SetPositionReference_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    SetPositionReference_Outputs_wrapper(Address, Value, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    SetPositionReference_Terminate_wrapper(pW);
