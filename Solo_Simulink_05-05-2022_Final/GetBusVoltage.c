 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu May 05 20:56:49 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME GetBusVoltage
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void GetBusVoltage_Start_wrapper(void **pW);
extern void GetBusVoltage_Outputs_wrapper(const uint8_T *Address,
			real32_T *Result,
			int32_T *Error,
			void **pW);
extern void GetBusVoltage_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    GetBusVoltage_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    GetBusVoltage_Outputs_wrapper(Address, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    GetBusVoltage_Terminate_wrapper(pW);
