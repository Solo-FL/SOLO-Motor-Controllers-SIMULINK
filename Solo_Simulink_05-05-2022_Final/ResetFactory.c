 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed May 04 11:46:38 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME ResetFactory
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void ResetFactory_Start_wrapper(void **pW);
extern void ResetFactory_Outputs_wrapper(const uint8_T *Address,
			boolean_T *Result,
			int32_T *Error,
			void **pW);
extern void ResetFactory_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    ResetFactory_Outputs_wrapper(Address, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    ResetFactory_Terminate_wrapper(pW);
