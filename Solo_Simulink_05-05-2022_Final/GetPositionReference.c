 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu May 05 20:07:38 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME GetPositionReference
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void GetPositionReference_Start_wrapper(void **pW);
extern void GetPositionReference_Outputs_wrapper(const uint8_T *Address,
			uint32_T *Result,
			int32_T *Error,
			void **pW);
extern void GetPositionReference_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    GetPositionReference_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    GetPositionReference_Outputs_wrapper(Address, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    GetPositionReference_Terminate_wrapper(pW);
