 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu May 05 19:25:12 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME GetFeedbackControlMode
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void GetFeedbackControlMode_Start_wrapper(void **pW);
extern void GetFeedbackControlMode_Outputs_wrapper(const uint8_T *Address,
			uint32_T *Result,
			int32_T *Error,
			void **pW);
extern void GetFeedbackControlMode_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    GetFeedbackControlMode_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    GetFeedbackControlMode_Outputs_wrapper(Address, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    GetFeedbackControlMode_Terminate_wrapper(pW);
