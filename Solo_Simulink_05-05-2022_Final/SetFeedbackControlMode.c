 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed May 04 11:43:07 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME SetFeedbackControlMode
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void SetFeedbackControlMode_Start_wrapper(void **pW);
extern void SetFeedbackControlMode_Outputs_wrapper(const uint8_T *Address,
			const uint8_T *Value,
			boolean_T *Result,
			int32_T *Error,
			void **pW);
extern void SetFeedbackControlMode_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    SetFeedbackControlMode_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    SetFeedbackControlMode_Outputs_wrapper(Address, Value, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    SetFeedbackControlMode_Terminate_wrapper(pW);
