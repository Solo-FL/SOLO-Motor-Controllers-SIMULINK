 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed May 04 11:44:26 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME ResetDeviceAddress
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void ResetDeviceAddress_Start_wrapper(void **pW);
extern void ResetDeviceAddress_Outputs_wrapper(const uint8_T *Address,
			boolean_T *Result,
			int32_T *Error,
			void **pW);
extern void ResetDeviceAddress_Terminate_wrapper(void **pW);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlStart(SimStruct *S)
{
    ...
    ResetDeviceAddress_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    ResetDeviceAddress_Outputs_wrapper(Address, Result, Error, pW);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    ResetDeviceAddress_Terminate_wrapper(pW);
