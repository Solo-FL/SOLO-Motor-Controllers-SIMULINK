 ...
 *
 */
void GetOutputPwmFrequencyKhz_Start_wrapper(void **pW)
{
...
pW[1] = GetProcAddress(pW[0], "_GetOutputPwmFrequencyKhz");
 ...
 *
 */
void GetOutputPwmFrequencyKhz_Terminate_wrapper(void **pW)
{
