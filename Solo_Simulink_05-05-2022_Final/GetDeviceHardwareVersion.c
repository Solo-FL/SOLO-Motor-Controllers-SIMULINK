/*
 * File: GetDeviceHardwareVersion.c
 *
 *
...
#define S_FUNCTION_NAME GetDeviceHardwareVersion
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlStart(SimStruct *S)
{
    ...
    GetDeviceHardwareVersion_Start_wrapper(pW);
}
#endif /*  MDL_START */
...
static void mdlTerminate(SimStruct *S)
{
    ...
    GetDeviceHardwareVersion_Terminate_wrapper(pW);
