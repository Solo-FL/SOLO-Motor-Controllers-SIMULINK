...
bool Kavaser::CANOpenTransmit(int hnd, uint8_t _address, uint16_t _object, uint8_t* _informatrionToSend, int& error)
{
	canStatus stat;
	long ID_Read;
	uint8_t  DLC_Read;
...
bool Kavaser::CANOpenGenericTransmit(int hnd, uint16_t _ID , uint8_t *_DLC, uint8_t* _Data, int& error)
{
	canStatus stat;
...
bool Kavaser::CANOpenReceive(int hnd, uint8_t _address, uint16_t _object, uint8_t* _informatrionToSend, uint8_t* _informationReceived, int& error)
{
	canStatus stat;
	long ID_Read;
	uint8_t  DLC_Read;
...
bool Kavaser::CANOpenGenericReceive(int hnd, uint16_t *_ID , uint8_t *_DLC, uint8_t* _Data)
{
	canStatus stat;
	long ID_Read;
	uint8_t  DLC_Read;
